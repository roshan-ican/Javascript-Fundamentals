...
// // splice
// // the splice method changes the array
...
// if it's mulitple of 3 print fizz
// if it's multiple of 5 print buzz
...
// // splice
// // it works same as slice but it does mutates the array
...
// The new at method
const array = [23, 11, 334, 43];
console.log(array[0]);
console.log(array.flat(0));
//useful when you are unknown of the number of elements from a array
console.log(array[array.length - 1]);
console.log(array.slice(-1)[0]);
// console.log(array.at(-1));
// when we are doing method chaining the at method is useful
// console.log('jonas'.at[0]);
// console.log('jonas'.at[-1]);

// for each method
// positives are deposite and negative are withdrawls
const movements = [200, 450, -400, 3000, -650, -130, 70, 1300];
...
// for each mehod is much easier to do the above stuff
console.log('-------forEach-------');
